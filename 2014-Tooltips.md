# Tooltips for the Basic Rules (2014)
...
## Chapter 2: Races
### Choosing a Race
- `[rule]Race[/rule]` `[rule]Race;Races[/rule]` `[rule]Race;Species[/rule]`
## Chapter 3: Classes
### Classes
...
- `[rule]Lawful Neutral[/rule]` `[rule]Lawful Neutral;LG[/rule]`
- `[rule]Neutral[/rule]` `[rule]Neutral;True Neutral[/rule]` `[rule]Neutral;N[/rule]`
- `[rule]Chaotic Neutral[/rule]` `[rule]Chaotic Neutral;CN[/rule]`
- `[rule]Lawful Evil[/rule]` `[rule]Lawful Evil;LE[/rule]`
